...
public class EmployeeMapper {
    ...
    public Employee toEntity(EmployeeDto employeeDto) {
        ...
        employee.setDisable(employeeDto.getDisable());
        ...
        employee.setEmailAdress(employeeDto.getEmailAddress());
    ...
    public EmployeeDto toDto(Employee employee) {
        ...
        employeeDto.setDisable(employee.getDisable());
        employeeDto.setEmailAddress(employee.getEmailAdress());
