...
import com.dotin.RequestManager.mapper.CategoryElementMapper;
...
public class CategoryElementService {
    private final static org.apache.log4j.Logger log = Logger.getLogger(CategoryElementService.class.getName());
    ...
    public void delete(Long id) {
        ...
        try {
            ...
            categoryElement.setDisable(true);
            transaction.commit();
        } finally {
            session.close();
        }
